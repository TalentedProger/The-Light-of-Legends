...
async def our_site(message: Message):
    ...
    caption = (
    "✨ Наш проект создан для сохранения и популяризации истории и культуры Черкесов.\n\n"
    "📖 Здесь вы найдёте материалы о традициях, легендах и наследии, которые формировали "
    "самобытность народа на протяжении веков.\n\n"
    "🌿 Мы стремимся объединить прошлое и настоящее, чтобы знания о культуре не терялись, "
    "а становились доступными каждому.\n\n"
    '<b>Узнайте больше на <a href="https://talentedproger.github.io/AdygheTails">нашем сайте</a></b> ✨'
)
